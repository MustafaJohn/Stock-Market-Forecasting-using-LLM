...
alpha = 0.001
estimation_window = 21  # set here, avoid overriding inside function
...
results_df.to_csv('model_results.csv (21-window).csv', index=False)
# Save predictions to CSV
wide_preds_df.sort_values(['DlyCalDt', 'PERMNO'], inplace=True)
wide_preds_df.to_csv('model_predictions.csv (21-window).csv', index=False)
