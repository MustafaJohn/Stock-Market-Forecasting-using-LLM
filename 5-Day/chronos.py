...
y_chr_bolt_tiny = pd.Series([m.cpu().squeeze().item() for m in means])
...
quantiles, means = pipeline.predict_quantiles(context=contexts, prediction_length=1, quantile_levels=[0.5])
y_chr_bolt_mini = pd.Series([m.cpu().squeeze().item() for m in means])
...
quantiles, means = pipeline.predict_quantiles(context=contexts, prediction_length=1, quantile_levels=[0.5])
y_chr_bolt_small = pd.Series([m.cpu().squeeze().item() for m in means])
...
quantiles, means = pipeline.predict_quantiles(context=contexts, prediction_length=1, quantile_levels=[0.5])
y_chr_bolt_base = pd.Series([m.cpu().squeeze().item() for m in means])
...
quantiles, means = pipeline.predict_quantiles(context=contexts, prediction_length=1, quantile_levels=[0.5])
y_chr_t5_tiny = pd.Series([m.cpu().squeeze().item() for m in means])
...
quantiles, means = pipeline.predict_quantiles(context=contexts, prediction_length=1, quantile_levels=[0.5])
y_chr_t5_mini = pd.Series([m.cpu().squeeze().item() for m in means])
...
quantiles, means = pipeline.predict_quantiles(context=contexts, prediction_length=1, quantile_levels=[0.5])
y_chr_t5_small = pd.Series([m.cpu().squeeze().item() for m in means])
...
# %% Results matrix
results_matrix = [
    {"Model": "Chronos-Bolt-Tiny", "R-squared": r2_chr_bolt_tiny, "MSE": mse_chr_bolt_tiny, "MAE": mae_chr_bolt_tiny,
     "Direction Accuracy": da_chr_bolt_tiny, "Up Directional Accuracy": up_da_chr_bolt_tiny, "Down Directional Accuracy": down_da_chr_bolt_tiny},
    {"Model": "Chronos-Bolt-Mini", "R-squared": r2_chr_bolt_mini, "MSE": mse_chr_bolt_mini, "MAE": mae_chr_bolt_mini,
     "Direction Accuracy": da_chr_bolt_mini, "Up Directional Accuracy": up_da_chr_bolt_mini, "Down Directional Accuracy": down_da_chr_bolt_mini},
    {"Model": "Chronos-Bolt-Small", "R-squared": r2_chr_bolt_small, "MSE": mse_chr_bolt_small, "MAE": mae_chr_bolt_small,
     "Direction Accuracy": da_chr_bolt_small, "Up Directional Accuracy": up_da_chr_bolt_small, "Down Directional Accuracy": down_da_chr_bolt_small},
    {"Model": "Chronos-Bolt-Base", "R-squared": r2_chr_bolt_base, "MSE": mse_chr_bolt_base, "MAE": mae_chr_bolt_base,
     "Direction Accuracy": da_chr_bolt_base, "Up Directional Accuracy": up_da_chr_bolt_base, "Down Directional Accuracy": down_da_chr_bolt_base},
    {"Model": "Chronos-T5-Tiny", "R-squared": r2_chr_t5_tiny, "MSE": mse_chr_t5_tiny, "MAE": mae_chr_t5_tiny,
     "Direction Accuracy": da_chr_t5_tiny, "Up Directional Accuracy": up_da_chr_t5_tiny, "Down Directional Accuracy": down_da_chr_t5_tiny},
    {"Model": "Chronos-T5-Mini", "R-squared": r2_chr_t5_mini, "MSE": mse_chr_t5_mini, "MAE": mae_chr_t5_mini,
     "Direction Accuracy": da_chr_t5_mini, "Up Directional Accuracy": up_da_chr_t5_mini, "Down Directional Accuracy": down_da_chr_t5_mini},
    {"Model": "Chronos-T5-Small", "R-squared": r2_chr_t5_small, "MSE": mse_chr_t5_small, "MAE": mae_chr_t5_small,
     "Direction Accuracy": da_chr_t5_small, "Up Directional Accuracy": up_da_chr_t5_small, "Down Directional Accuracy": down_da_chr_t5_small}
]

results_matrix_df = pd.DataFrame(results_matrix)
results_matrix_df.to_csv("results_chronos_5_day.csv", index=False)

# %%
# Save predictions
results.to_csv("chronos(5-day).csv", index=False)
