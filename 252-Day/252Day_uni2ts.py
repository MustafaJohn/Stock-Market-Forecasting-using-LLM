...
predictor = moirai_s.create_predictor(batch_size=1024)
predictor.to(device)
...
predictor = moirai_moe_s.create_predictor(batch_size=1024)
predictor.to(device)
...
predictor = moirai_moe_b.create_predictor(batch_size=1024)
predictor.to(device)
...
results_matrix_df.to_csv("uni2ts(252-day)results.csv", index=False)

# %%
# Save predictions
results.to_csv("uni2ts(252-day)predictions.csv", index=False)
