...
WINDOW = 512  # rolling window size to use as predictors (for TimesFM window size should be multiple of 32 - input patch length)
DATE_COL = 'DlyCalDt'
ID_COL = 'PERMNO'
...
results_matrix_df.to_csv("timesfm(512-day)_results.csv", index=False)

# %%
# Save Prediction Results
results.to_csv("timesfm(512-day)_predictions.csv", index=False)
